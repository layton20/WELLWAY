    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HospitalPatientId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    GenderIdentity = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_HospitalPatientId",
                table: "Patients",
                column: "HospitalPatientId",
                unique: true);
